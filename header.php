				...
				<div id="header-middle" class="container-inner">
					...
					<?php if ( has_nav_menu('mobile') ): ?>
						<div id="wrap-nav-mobile" class="wrap-nav">
							<?php \Curver\Nav::nav_menu(array('theme_location'=>'mobile','menu_id' => 'nav-mobile','fallback_cb'=> false)); ?>
					...
					<?php if ( has_nav_menu('header') ): ?>
						<div id="wrap-nav-header" class="wrap-nav">
							<?php \Curver\Nav::nav_menu(array('theme_location'=>'header','menu_id' => 'nav-header','fallback_cb'=> false)); ?>
