...
if ( ! function_exists( 'curver_load' ) ) {
	
	function curver_load() {
		// Load theme languages
		load_theme_textdomain( 'curver', get_template_directory().'/languages' );
...
add_action( 'after_setup_theme', 'curver_load' );	
...
/*  Theme setup
/* ------------------------------------ */
if ( ! function_exists( 'curver_setup' ) ) {
	
	function curver_setup() {
		// Enable title tag
		...
		// Thumbnail sizes
		add_image_size( 'curver-small', 200, 200, true );
		add_image_size( 'curver-medium', 520, 292, true );
		add_image_size( 'curver-large', 720, 404, true );
		add_image_size( 'curver-list', 320, 320, true );
		...
		register_nav_menus( array(
			'mobile' 	=> esc_html__( 'Mobile', 'curver' ),
			'header' 	=> esc_html__( 'Header', 'curver' ),
			'footer' 	=> esc_html__( 'Footer', 'curver' ),
		) );
	}
...
add_action( 'after_setup_theme', 'curver_custom_logo' );


/*  Custom header
/* ------------------------------------ */
if ( ! function_exists( 'curver_custom_header' ) ) {
	
	function curver_custom_header() {
		$args = array(
			'default-image'	=> false,
			'default-text'	=> false,
			'width'			=> 1120,
...
add_action( 'after_setup_theme', 'curver_custom_header' );


/*  Custom background
/* ------------------------------------ */
if ( ! function_exists( 'curver_custom_background' ) ) {
	
	function curver_custom_background() {
		$args = array();
		add_theme_support( 'custom-background', $args );
	}
	
}
add_action( 'after_setup_theme', 'curver_custom_background' );


/*  Deregister
/* ------------------------------------ */
if ( ! function_exists( 'curver_deregister' ) ) {
	
	function curver_deregister() {
		wp_deregister_style( 'wp-pagenavi' );
	}
	
}
add_action( 'wp_enqueue_scripts', 'curver_deregister', 100 );


/*  Register sidebars
/* ------------------------------------ */	
if ( ! function_exists( 'curver_sidebars' ) ) {

	function curver_sidebars()	{
		register_sidebar(array( 'name' => esc_html__('Primary','curver'),'id' => 'primary','description' => esc_html__("Normal full width sidebar","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
		
		if ( get_theme_mod('footer-ads') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Footer Ads',"curver"),'id' => 'footer-ads', 'description' => esc_html__("Footer ads area","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		
		if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 1','curver'),'id' => 'frontpage-top-1', 'description' => esc_html__("Frontpage area","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 2','curver'),'id' => 'frontpage-top-2', 'description' => esc_html__("Frontpage area","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 1','curver'),'id' => 'frontpage-bottom-1', 'description' => esc_html__("Frontpage area","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 2','curver'),'id' => 'frontpage-bottom-2', 'description' => esc_html__("Frontpage area","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		
		if ( get_theme_mod('footer-widgets') >= '1' ) { register_sidebar(array( 'name' => esc_html__('Footer 1','curver'),'id' => 'footer-1', 'description' => esc_html__("Widgetized footer","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '2' ) { register_sidebar(array( 'name' => esc_html__('Footer 2','curver'),'id' => 'footer-2', 'description' => esc_html__("Widgetized footer","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '3' ) { register_sidebar(array( 'name' => esc_html__('Footer 3','curver'),'id' => 'footer-3', 'description' => esc_html__("Widgetized footer","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '4' ) { register_sidebar(array( 'name' => esc_html__('Footer 4','curver'),'id' => 'footer-4', 'description' => esc_html__("Widgetized footer","curver"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
	}
	
}
add_action( 'widgets_init', 'curver_sidebars' );


/*  Enqueue javascript
/* ------------------------------------ */	
if ( ! function_exists( 'curver_scripts' ) ) {
...
add_action( 'wp_enqueue_scripts', 'curver_scripts' ); 


/*  Enqueue css
/* ------------------------------------ */	
if ( ! function_exists( 'curver_styles' ) ) {
...
add_action( 'wp_enqueue_scripts', 'curver_styles' );
...
/*  Layout class
/* ------------------------------------ */
if ( ! function_exists( 'curver_layout_class' ) ) {
	
	function curver_layout_class() {
		// Default layout
		$layout = 'col-2cl';
		$default = 'col-2cl';
...
/* ------------------------------------ */
if ( ! function_exists( 'curver_sidebar_primary' ) ) {
	
	function curver_sidebar_primary() {
		// Default sidebar
		$sidebar = 'primary';
...
/* ------------------------------------ */
if ( ! function_exists( 'curver_sidebar_secondary' ) ) {

	function curver_sidebar_secondary() {
		// Default sidebar
		$sidebar = 'secondary';
...
/*  Social links
/* ------------------------------------ */
if ( ! function_exists( 'curver_social_links' ) ) {

	function curver_social_links() {
...
/*  Site name/logo
/* ------------------------------------ */
if ( ! function_exists( 'curver_site_title' ) ) {

	function curver_site_title() {
...
/*  Blog title
/* ------------------------------------ */
if ( ! function_exists( 'curver_blog_title' ) ) {

	function curver_blog_title() {
		global $post;
...
/*  Related posts
/* ------------------------------------ */
if ( ! function_exists( 'curver_related_posts' ) ) {

	function curver_related_posts() {
		wp_reset_postdata();
		global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'curver_post_images' ) ) {

	function curver_post_images( $args=array() ) {
		global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'curver_get_featured_post_ids' ) ) {

	function curver_get_featured_post_ids() {
		$args = array(
...
/*  Body class
/* ------------------------------------ */
if ( ! function_exists( 'curver_body_class' ) ) {
	
	function curver_body_class( $classes ) {
		$classes[] = curver_layout_class();
...
add_filter( 'body_class', 'curver_body_class' );


/*  Excerpt ending
/* ------------------------------------ */
if ( ! function_exists( 'curver_excerpt_more' ) ) {

	function curver_excerpt_more( $more ) {
		if ( is_admin() ) {
			return $more;
		}
		return '&#46;&#46;&#46;';
...
add_filter( 'excerpt_more', 'curver_excerpt_more' );


/*  Excerpt length
/* ------------------------------------ */
if ( ! function_exists( 'curver_excerpt_length' ) ) {

	function curver_excerpt_length( $length ) {
		if ( is_admin() ) {
			return $length;
		}
...
add_filter( 'excerpt_length', 'curver_excerpt_length', 999 );


/*  Add responsive container to embeds
/* ------------------------------------ */	
if ( ! function_exists( 'curver_embed_html' ) ) {

	function curver_embed_html( $html, $url ) {
...
add_filter( 'embed_oembed_html', 'curver_embed_html', 10, 3 );


/*  Add responsive container to jetpack embeds
/* ------------------------------------ */	
if ( ! function_exists( 'curver_embed_html_jp' ) ) {

	function curver_embed_html_jp( $html ) {
		return '<div class="video-container">' . $html . '</div>';
	}

}
add_filter( 'video_embed_html', 'curver_embed_html_jp' );
...
/* ------------------------------------ */
if ( ! function_exists( 'curver_pre_get_posts' ) ) {

	function curver_pre_get_posts( $query ) {
		...
		if ( $query->is_home() ) {
			...
			if ( get_theme_mod('featured-posts-count','0') != '0' ) {
				// Get featured post ids
				$featured_post_ids = curver_get_featured_post_ids();
				// Exclude posts
...
add_action( 'pre_get_posts', 'curver_pre_get_posts' );
...
if ( ! function_exists( 'curver_admin_panel_css' ) ) {
	...
	function curver_admin_panel_css() {
		global $pagenow;
...
add_action( 'admin_head', 'curver_admin_panel_css' );


/*  TGM plugin activation
/* ------------------------------------ */
if ( ! function_exists( 'curver_plugins' ) ) {
	
	function curver_plugins() {	
		if ( get_theme_mod('recommended-plugins','on') =='on' ) { 	
			// Add the following plugins
			$plugins = array(
				array(
					'name' => esc_html__( 'Alx Extensions', 'curver' ),
					'slug' => 'alx-extensions',
				),
				array(
					'name' => esc_html__( 'Meta Box', 'curver' ),
					'slug' => 'meta-box',
				),
				array(
					'name' => esc_html__( 'Regenerate Thumbnails', 'curver' ),
...
add_action( 'tgmpa_register', 'curver_plugins' );


/*  WooCommerce basic support
/* ------------------------------------ */
function curver_wc_wrapper_start() {
	echo '<div class="content">';
	echo '<div class="pad">';
}
function curver_wc_wrapper_end() {
	echo '</div>';
	echo '</div>';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10);
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10);
add_action('woocommerce_before_main_content', 'curver_wc_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'curver_wc_wrapper_end', 10);
...
/*  Flexslider featured
/* ------------------------------------ */
if ( ! function_exists( 'curver_flexslider_featured' ) ) {
	
	function curver_flexslider_featured() {
		...
		if( is_home() && !is_paged() && ( get_theme_mod('featured-posts-count','0') !='0') ) {
			...
			wp_add_inline_script( 'curver-scripts', $script );
			
		}
	}
	
}
add_action( 'wp_enqueue_scripts', 'curver_flexslider_featured' );
	

/*  Flexslider gallery post format
/* ------------------------------------ */
if ( ! function_exists( 'curver_flexslider_gallery' ) ) {

	function curver_flexslider_gallery() {
